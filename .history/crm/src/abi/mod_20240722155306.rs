...
impl CrmService {
    pub async fn welcome(&self, req: WelcomeRequest) -> Result<Response<WelcomeResponse>, Status> {
        ...
        pub async fn recall(&self, req: RecallRequest) -> Result<Response<RecallResponse>, Status> {
            ...
            let contents_vec: Vec<Result<crm_metadata::pb::Content, Status>> = contents.try_collect().await?;

let mut scored_contents: Vec<(crm_metadata::pb::Content, f64)> = contents_vec
    .into_iter()
