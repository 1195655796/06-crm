...
#[derive(Default, Debug, Clone, Dummy, Serialize, Deserialize, PartialEq, Eq, ::prost::Message)]
...
#[derive(prost::Message,Debug, Clone, Dummy, Serialize, Deserialize, PartialEq, Eq, FromRow)]
pub struct UserStat {
...
impl prost::Message for UserStat {
    impl prost::Message for gen::UserStat {
